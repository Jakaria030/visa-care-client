    ...
    return (
        <div className='flex flex-col items-center border-2 rounded-md hover:shadow-lg'>
            ...
            <div className='pt-2 pb-5 text-center'>
                ...
                <Link to={`/visaDetails/${_id}`}><button className='px-4 sm:py-2 rounded-sm bg-[#003366] text-[#F2F2F2] active:scale-95 font-semibold font-inter mt-3'>See Details</button></Link>
            </div>
        </div>
    );
};
