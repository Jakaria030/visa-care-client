...
const FAQsPage = () => {
    return (
        <section className='max-w-8xl mx-auto px-5'>
            <div className="my-5 md:my-10 flex flex-col md:flex-row md:justify-between gap-8 md:gap-16">
                <div className="md:basis-1/2">
                    <div>
                        <h2 className="text-2xl md:text-3xl font-semibold text-[#003366] mb-5">Genral Questions</h2>
                        <div className="collapse rounded-md collapse-arrow bg-gray-100 mb-5">
                    ...
                    <div>
                        <h2 className="text-2xl md:text-3xl font-semibold text-[#003366] mb-5">Tourist Visa</h2>
                        <div className="collapse rounded-md collapse-arrow bg-gray-100 mb-5">
                            <input type="radio" name="my-accordion-2" />
                ...
                <div className="md:basis-1/2">
                    <div>
                        <h2 className="text-2xl md:text-3xl font-semibold text-[#003366] mb-5">Study Visa</h2>
                        <div className="collapse rounded-md collapse-arrow bg-gray-100 mb-5">
                            <input type="radio" name="my-accordion-2"/>
