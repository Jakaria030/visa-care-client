        ...
        <section className='max-w-8xl mx-auto content-center px-5 min-h-[60vh] font-inter'>
            <div className='card w-full max-w-lg border-2 my-5 mx-auto'>
                ...
                <div className='form-control mx-4 sm:mx-8 pb-10'>
                    ...
                    <span className='label-text text-center mt-3'>Don't have an account? <Link to='/registerPage' className='underline hover:text-[#FF6F3F] font-bold duration-150 transition-colors'>Register</Link></span>
                </div>
            </div>
        </section>
    );
