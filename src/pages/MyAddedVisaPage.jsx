    ...
    return (
        <div className={`${isDarkMode ? 'bg-[#121212]' : 'bg-white'}`}>
            <section className='max-w-8xl mx-auto px-5 py-8 md:py-16'>
                {
                    loading ? (<LoadingPage />) : myAddedVisas.length > 0 ? (<div className="overflow-x-auto">
                        <table className="table">
                            {/* head */}
                            <thead className={`text-xl font-semibold text-center border-b-2 ${isDarkMode ? 'text-[#F2F2F2] border-white' : 'text-[#003366] border-[#003366]'}`}>
                                <tr>
                                    <th>Country Image</th>
                                    <th>Country Name</th>
                ...
                <dialog id="update_modal" className="modal modal-middle">
                    <div className={`modal-box max-w-3xl rounded-md px-3 ${isDarkMode && 'bg-gray-600'}`}>
                        <div className='card w-full max-w-4xl border-2 mx-auto py-2 sm:py-5'>
                            <h2 className={`text-2xl sm:text-3xl font-semibold font-poppins mx-4 sm:mx-8 text-center ${isDarkMode && 'text-[#F2F2F2]'}`}>Update Visa Form</h2>
                            <form onSubmit={handleUpdateVisa} className='card-body px-4 sm:px-8 py-5'>
                                ...
                                <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-5'>
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Country Image</span>
                                        </label>
                                    ...
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Country Flag</span>
                                        </label>
                                ...
                                <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-5'>
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Country Name</span>
                                        </label>
                                    ...
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Visa Type</span>
                                        </label>
                                ...
                                <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-5'>
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Processing Time</span>
                                        </label>
                                    ...
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Age Restriction</span>
                                        </label>
                                ...
                                <div className='flex flex-col sm:flex-row items-center gap-2 sm:gap-5'>
                                    ...
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Application Method</span>
                                        </label>
                                ...
                                <div>
                                    <div className='form-control w-full sm:basis-1/2'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Validity</span>
                                        </label>
                                ...
                                <div className='flex flex-col sm:flex-row gap-2 sm:gap-5'>
                                    <div className='form-control'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Required Documents</span>
                                        </label>
                                        <label className='label justify-start gap-3 cursor-pointer'>
                                            <input type='checkbox' name='validPassport' value='Valid Passport' className={`checkbox rounded-md ${isDarkMode && 'border-white'}`} defaultChecked />
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Valid Passport</span>
                                        </label>
                                        <label className='label justify-start gap-3 cursor-pointer'>
                                            <input type='checkbox' name='visaForm' value='Visa Application Form' className={`checkbox rounded-md ${isDarkMode && 'border-white'}`} />
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Visa Application Form</span>
                                        </label>
                                        <label className='label justify-start gap-3 cursor-pointer'>
                                            <input type='checkbox' name='recentPicture' value='Recent Passport Size Picture' className={`checkbox rounded-md ${isDarkMode && 'border-white'}`} />
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Recent Passport Size Picture</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className='form-control'>
                                        <label className='label'>
                                            <span className={`label-text ${isDarkMode && 'text-[#F2F2F2]'}`}>Description</span>
                                        </label>
                                ...
                                <div className='form-control mt-5'>
                                    <button className={`py-2 rounded-md text-[#F2F2F2] active:scale-95 ${isDarkMode ? 'bg-[#FF6F3F]' : 'bg-[#003366]'}`}>Update Visa</button>
                                </div>
                            </form>
                        </div>
